...
const AdminProjectsPage = () => {
    ...
    const handleDelete = async (projectId: number) => {
        const confirmeDelete = window.confirm('Are you sure you want to delete this project?');
                ...
                <tbody>
                    {
                        projects.map((p) => (
                            <tr key={p.projectId}>
                                ...
                                <td>
                                    <button className="btn btn-primary btn-sm w-100 mb-1" onClick={() => setEditingProject(p)}
                                    >
                                        Edit
                                    </button>
                                    <button className="btn btn-danger btn-sm w-100 mb-1" onClick={() => handleDelete(p.projectId)}
                                    >
                                        Delete
                                    </button>
                                </td>
